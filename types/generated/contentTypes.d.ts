...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['active', 'invited', 'expired', 'blocked']>;
    expiry: Attribute.Integer & Attribute.DefaultTo<0>;
...
export interface ApiSubscriptionPlanSubscriptionPlan
  ...
  attributes: {
    ...
    subscription_duration: Attribute.Integer;
    subscriptions: Attribute.Relation<
      'api::subscription-plan.subscription-plan',
      'oneToMany',
      'api::subscription.subscription'
    >;
    auto_subscription: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
